            ...
            <div className='h-full w-3/4 mx-auto'>
                <div>
                    ...
                    <div className='mt-16 px-6 flex items-center gap-8'>
                        <span className='flex items-center gap-2 capitalize'><CiLocationOn /> {listing?.location}</span>
                        <span className='flex items-center gap-2'>{format(listing?.pricePerNight, { locale: 'en-us' })}/night</span>
