    ...
    <div className='relative h-screen w-full'>
      <div className='relative h-full w-full'>
        <Image
          ...
          alt=""
        />
        <div className='h-[470px] w-[400px] bg-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg'>
          ...
          <Link
            className='block text-center mt-1 py-2 mx-auto text-slate-500 hover:text-slate-700'
            href={'/login'}
          >
            Login
          </Link>
